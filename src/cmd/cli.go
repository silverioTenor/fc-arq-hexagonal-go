...
to quickly create a Cobra application.`,
	Run: func(cmd *cobra.Command, args []string) {
		response, err := cli.Run(productService, action, productId, productName, productPrice)
...
func init() {
	...
	cliCmd.Flags().StringVarP(&action, "action", "a", "enable", "Action to enable / disable a product")
